...
# # End of template
# ----------------------------------------
# If AudioConfig is one of several IP cores in your
...
# ----------------------------------------
# ACDS 15.1 185 win32 2016.02.21.20:46:01
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "AudioConfig"
}
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/AudioConfig.vhd"
}
