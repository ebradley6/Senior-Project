...
# ACDS 15.1 185 win32 2016.02.07.13:54:14
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/AudioClk_audio_pll_0_audio_pll.vho"          -work audio_pll         -cdslib ./cds_libs/audio_pll.cds.lib        
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/AudioClk_audio_pll_0.vhd"                    -work audio_pll_0       -cdslib ./cds_libs/audio_pll_0.cds.lib      
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/AudioClk.vhd"                                                                                                               
fi
