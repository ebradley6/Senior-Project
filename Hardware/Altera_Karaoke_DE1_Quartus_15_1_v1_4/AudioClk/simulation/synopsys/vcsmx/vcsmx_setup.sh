...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/AudioClk_audio_pll_0_audio_pll.vho"          -work audio_pll        
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/AudioClk_audio_pll_0.vhd"                    -work audio_pll_0      
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/AudioClk.vhd"                                                                  
fi
