...
/*
 * Macros for device 'hps_fifo_wav_0_in', class 'altera_avalon_fifo'
 * The macros are prefixed with 'HPS_FIFO_WAV_0_IN_'.
 * The prefix is the slave descriptor.
 */
#define HPS_FIFO_WAV_0_IN_COMPONENT_TYPE altera_avalon_fifo
#define HPS_FIFO_WAV_0_IN_COMPONENT_NAME hps_fifo_wav_0
#define HPS_FIFO_WAV_0_IN_BASE 0x0
#define HPS_FIFO_WAV_0_IN_SPAN 8
#define HPS_FIFO_WAV_0_IN_END 0x7
#define HPS_FIFO_WAV_0_IN_AVALONMM_AVALONMM_DATA_WIDTH 32
#define HPS_FIFO_WAV_0_IN_AVALONMM_AVALONST_DATA_WIDTH 32
#define HPS_FIFO_WAV_0_IN_BITS_PER_SYMBOL 32
#define HPS_FIFO_WAV_0_IN_CHANNEL_WIDTH 0
#define HPS_FIFO_WAV_0_IN_ERROR_WIDTH 0
#define HPS_FIFO_WAV_0_IN_FIFO_DEPTH 2048
#define HPS_FIFO_WAV_0_IN_SINGLE_CLOCK_MODE 0
#define HPS_FIFO_WAV_0_IN_SYMBOLS_PER_BEAT 1
#define HPS_FIFO_WAV_0_IN_USE_AVALONMM_READ_SLAVE 0
#define HPS_FIFO_WAV_0_IN_USE_AVALONMM_WRITE_SLAVE 1
#define HPS_FIFO_WAV_0_IN_USE_AVALONST_SINK 0
#define HPS_FIFO_WAV_0_IN_USE_AVALONST_SOURCE 1
#define HPS_FIFO_WAV_0_IN_USE_BACKPRESSURE 1
#define HPS_FIFO_WAV_0_IN_USE_IRQ 0
#define HPS_FIFO_WAV_0_IN_USE_PACKET 0
#define HPS_FIFO_WAV_0_IN_USE_READ_CONTROL 0
#define HPS_FIFO_WAV_0_IN_USE_REGISTER 0
#define HPS_FIFO_WAV_0_IN_USE_WRITE_CONTROL 1
...
/*
 * Macros for device 'hps_fifo_wav_0_in_csr', class 'altera_avalon_fifo'
 * The macros are prefixed with 'HPS_FIFO_WAV_0_IN_CSR_'.
 * The prefix is the slave descriptor.
 */
#define HPS_FIFO_WAV_0_IN_CSR_COMPONENT_TYPE altera_avalon_fifo
#define HPS_FIFO_WAV_0_IN_CSR_COMPONENT_NAME hps_fifo_wav_0
#define HPS_FIFO_WAV_0_IN_CSR_BASE 0x1000
#define HPS_FIFO_WAV_0_IN_CSR_SPAN 32
#define HPS_FIFO_WAV_0_IN_CSR_END 0x101f
#define HPS_FIFO_WAV_0_IN_CSR_AVALONMM_AVALONMM_DATA_WIDTH 32
#define HPS_FIFO_WAV_0_IN_CSR_AVALONMM_AVALONST_DATA_WIDTH 32
#define HPS_FIFO_WAV_0_IN_CSR_BITS_PER_SYMBOL 32
#define HPS_FIFO_WAV_0_IN_CSR_CHANNEL_WIDTH 0
#define HPS_FIFO_WAV_0_IN_CSR_ERROR_WIDTH 0
#define HPS_FIFO_WAV_0_IN_CSR_FIFO_DEPTH 2048
#define HPS_FIFO_WAV_0_IN_CSR_SINGLE_CLOCK_MODE 0
#define HPS_FIFO_WAV_0_IN_CSR_SYMBOLS_PER_BEAT 1
#define HPS_FIFO_WAV_0_IN_CSR_USE_AVALONMM_READ_SLAVE 0
#define HPS_FIFO_WAV_0_IN_CSR_USE_AVALONMM_WRITE_SLAVE 1
#define HPS_FIFO_WAV_0_IN_CSR_USE_AVALONST_SINK 0
#define HPS_FIFO_WAV_0_IN_CSR_USE_AVALONST_SOURCE 1
#define HPS_FIFO_WAV_0_IN_CSR_USE_BACKPRESSURE 1
#define HPS_FIFO_WAV_0_IN_CSR_USE_IRQ 0
#define HPS_FIFO_WAV_0_IN_CSR_USE_PACKET 0
#define HPS_FIFO_WAV_0_IN_CSR_USE_READ_CONTROL 0
#define HPS_FIFO_WAV_0_IN_CSR_USE_REGISTER 0
#define HPS_FIFO_WAV_0_IN_CSR_USE_WRITE_CONTROL 1
