...
module DE1_SoC_QSYS_mm_interconnect_0 (
	...
	wire    [0:0] alt_vip_vfr_0_avalon_master_limiter_cmd_src_valid;                              // alt_vip_vfr_0_avalon_master_limiter:cmd_src_valid -> limiter_pipeline:in_valid
	wire  [228:0] alt_vip_vfr_0_avalon_master_limiter_cmd_src_data;                               // alt_vip_vfr_0_avalon_master_limiter:cmd_src_data -> limiter_pipeline:in_data
	wire          alt_vip_vfr_0_avalon_master_limiter_cmd_src_ready;                              // limiter_pipeline:in_ready -> alt_vip_vfr_0_avalon_master_limiter:cmd_src_ready
	wire    [1:0] alt_vip_vfr_0_avalon_master_limiter_cmd_src_channel;                            // alt_vip_vfr_0_avalon_master_limiter:cmd_src_channel -> limiter_pipeline:in_channel
	wire          alt_vip_vfr_0_avalon_master_limiter_cmd_src_startofpacket;                      // alt_vip_vfr_0_avalon_master_limiter:cmd_src_startofpacket -> limiter_pipeline:in_startofpacket
	wire          alt_vip_vfr_0_avalon_master_limiter_cmd_src_endofpacket;                        // alt_vip_vfr_0_avalon_master_limiter:cmd_src_endofpacket -> limiter_pipeline:in_endofpacket
	wire          limiter_pipeline_source0_valid;                                                 // limiter_pipeline:out_valid -> cmd_demux:sink_valid
	wire  [228:0] limiter_pipeline_source0_data;                                                  // limiter_pipeline:out_data -> cmd_demux:sink_data
	...
	wire  [228:0] rsp_mux_src_data;                                                               // rsp_mux:src_data -> limiter_pipeline_001:in_data
	...
	wire          limiter_pipeline_001_source0_valid;                                             // limiter_pipeline_001:out_valid -> alt_vip_vfr_0_avalon_master_limiter:rsp_sink_valid
	wire  [228:0] limiter_pipeline_001_source0_data;                                              // limiter_pipeline_001:out_data -> alt_vip_vfr_0_avalon_master_limiter:rsp_sink_data
	wire          limiter_pipeline_001_source0_ready;                                             // alt_vip_vfr_0_avalon_master_limiter:rsp_sink_ready -> limiter_pipeline_001:out_ready
	wire    [1:0] limiter_pipeline_001_source0_channel;                                           // limiter_pipeline_001:out_channel -> alt_vip_vfr_0_avalon_master_limiter:rsp_sink_channel
	wire          limiter_pipeline_001_source0_startofpacket;                                     // limiter_pipeline_001:out_startofpacket -> alt_vip_vfr_0_avalon_master_limiter:rsp_sink_startofpacket
	wire          limiter_pipeline_001_source0_endofpacket;                                       // limiter_pipeline_001:out_endofpacket -> alt_vip_vfr_0_avalon_master_limiter:rsp_sink_endofpacket
	...
	wire  [228:0] hps_0_f2h_axi_slave_wr_burst_adapter_source0_data;                              // hps_0_f2h_axi_slave_wr_burst_adapter:source0_data -> agent_pipeline:in_data
	...
	wire  [228:0] hps_0_f2h_axi_slave_rd_burst_adapter_source0_data;                              // hps_0_f2h_axi_slave_rd_burst_adapter:source0_data -> agent_pipeline_001:in_data
	...
	wire  [228:0] agent_pipeline_002_source0_data;                                                // agent_pipeline_002:out_data -> router_001:sink_data
	...
	wire  [228:0] agent_pipeline_003_source0_data;                                                // agent_pipeline_003:out_data -> router_002:sink_data
	...
	DE1_SoC_QSYS_mm_interconnect_0_router_001 router_002 (
	...
	altera_avalon_st_pipeline_stage #(
		...
		.in_ready          (alt_vip_vfr_0_avalon_master_limiter_cmd_src_ready),            //     sink0.ready
		.in_valid          (alt_vip_vfr_0_avalon_master_limiter_cmd_src_valid),            //          .valid
