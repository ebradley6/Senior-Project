...
module DE1_SoC_QSYS_mm_interconnect_4 (
	...
	wire   [85:0] sdram_s1_burst_adapter_source0_data;                                           // sdram_s1_burst_adapter:source0_data -> agent_pipeline:in_data
	wire          sdram_s1_burst_adapter_source0_ready;                                          // agent_pipeline:in_ready -> sdram_s1_burst_adapter:source0_ready
	wire    [1:0] sdram_s1_burst_adapter_source0_channel;                                        // sdram_s1_burst_adapter:source0_channel -> agent_pipeline:in_channel
	...
	wire   [85:0] agent_pipeline_source0_data;                                                   // agent_pipeline:out_data -> sdram_s1_agent:cp_data
	wire          agent_pipeline_source0_ready;                                                  // sdram_s1_agent:cp_ready -> agent_pipeline:out_ready
	wire    [1:0] agent_pipeline_source0_channel;                                                // agent_pipeline:out_channel -> sdram_s1_agent:cp_channel
	...
	wire   [85:0] sdram_s1_agent_rp_data;                                                        // sdram_s1_agent:rp_data -> agent_pipeline_001:in_data
	...
	wire   [85:0] agent_pipeline_001_source0_data;                                               // agent_pipeline_001:out_data -> router_002:sink_data
	...
	DE1_SoC_QSYS_mm_interconnect_4_router router (
	...
	DE1_SoC_QSYS_mm_interconnect_4_router router_001 (
	...
	DE1_SoC_QSYS_mm_interconnect_4_router_002 router_002 (
	...
	DE1_SoC_QSYS_mm_interconnect_4_cmd_demux cmd_demux (
		.clk                (pll_sys_outclk0_clk),                             //       clk.clk
		.reset              (alt_vip_vfb_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DE1_SoC_QSYS_mm_interconnect_4_cmd_demux cmd_demux_001 (
		.clk                (pll_sys_outclk0_clk),                             //       clk.clk
		.reset              (alt_vip_vfb_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DE1_SoC_QSYS_mm_interconnect_4_cmd_mux cmd_mux (
		.clk                 (pll_sys_outclk0_clk),                             //       clk.clk
		.reset               (alt_vip_vfb_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DE1_SoC_QSYS_mm_interconnect_4_rsp_demux rsp_demux (
		.clk                (pll_sys_outclk0_clk),                             //       clk.clk
		.reset              (alt_vip_vfb_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DE1_SoC_QSYS_mm_interconnect_4_rsp_mux rsp_mux (
		.clk                 (pll_sys_outclk0_clk),                             //       clk.clk
		.reset               (alt_vip_vfb_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DE1_SoC_QSYS_mm_interconnect_4_rsp_mux rsp_mux_001 (
		.clk                 (pll_sys_outclk0_clk),                             //       clk.clk
		.reset               (alt_vip_vfb_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
