...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_width_adapter.sv"                                        -work hps_0_h2f_axi_master_wr_to_onchip_memory2_0_s1_cmd_width_adapter -cdslib ./cds_libs/hps_0_h2f_axi_master_wr_to_onchip_memory2_0_s1_cmd_width_adapter.cds.lib
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_address_alignment.sv"                                    -work hps_0_h2f_axi_master_wr_to_onchip_memory2_0_s1_cmd_width_adapter -cdslib ./cds_libs/hps_0_h2f_axi_master_wr_to_onchip_memory2_0_s1_cmd_width_adapter.cds.lib
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_burst_uncompressor.sv"                                   -work hps_0_h2f_axi_master_wr_to_onchip_memory2_0_s1_cmd_width_adapter -cdslib ./cds_libs/hps_0_h2f_axi_master_wr_to_onchip_memory2_0_s1_cmd_width_adapter.cds.lib
  ...
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_traffic_limiter.sv"                                      -work master_non_sec_master_limiter                                    -cdslib ./cds_libs/master_non_sec_master_limiter.cds.lib                                   
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_reorder_memory.sv"                                       -work master_non_sec_master_limiter                                    -cdslib ./cds_libs/master_non_sec_master_limiter.cds.lib                                   
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_avalon_sc_fifo.v"                                               -work master_non_sec_master_limiter                                    -cdslib ./cds_libs/master_non_sec_master_limiter.cds.lib                                   
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_avalon_st_pipeline_base.v"                                      -work master_non_sec_master_limiter                                    -cdslib ./cds_libs/master_non_sec_master_limiter.cds.lib                                   
  ...
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_master_agent.sv"                                         -work master_non_sec_master_agent                                      -cdslib ./cds_libs/master_non_sec_master_agent.cds.lib                                     
  ...
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_master_translator.sv"                                    -work master_non_sec_master_translator                                 -cdslib ./cds_libs/master_non_sec_master_translator.cds.lib                                
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/soc_system_master_non_sec_p2b_adapter.sv"                              -work p2b_adapter                                                      -cdslib ./cds_libs/p2b_adapter.cds.lib                                                     
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/soc_system_master_non_sec_b2p_adapter.sv"                              -work b2p_adapter                                                      -cdslib ./cds_libs/b2p_adapter.cds.lib                                                     
  ...
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/soc_system_master_non_sec_timing_adt.sv"                               -work timing_adt                                                       -cdslib ./cds_libs/timing_adt.cds.lib                                                      
  ...
  ncvlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_master_non_sec.v"                                           -work master_non_sec                                                   -cdslib ./cds_libs/master_non_sec.cds.lib                                                  
