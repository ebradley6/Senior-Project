...
# ACDS 15.1 185 win32 2016.02.07.13:54:15
# ----------------------------------------
...
# # End of template
# ----------------------------------------
# If AudioClk is one of several IP cores in your
...
alias com {
  ...
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/submodules/AudioClk_audio_pll_0_audio_pll.vho"          -work audio_pll        
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/submodules/AudioClk_audio_pll_0.vhd"                    -work audio_pll_0      
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/AudioClk.vhd"                                                                  
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim +access +r -t ps $ELAB_OPTIONS -L work -L reset_from_locked -L audio_pll -L audio_pll_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cyclonev $TOP_LEVEL_NAME
}
