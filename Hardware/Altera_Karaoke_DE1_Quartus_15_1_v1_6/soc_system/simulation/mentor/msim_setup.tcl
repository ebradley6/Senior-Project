...
alias com {
  ...
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_width_adapter.sv"                                        -L altera_common_sv_packages -work hps_0_h2f_axi_master_wr_to_onchip_memory2_0_s1_cmd_width_adapter
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_address_alignment.sv"                                    -L altera_common_sv_packages -work hps_0_h2f_axi_master_wr_to_onchip_memory2_0_s1_cmd_width_adapter
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_burst_uncompressor.sv"                                   -L altera_common_sv_packages -work hps_0_h2f_axi_master_wr_to_onchip_memory2_0_s1_cmd_width_adapter
  ...
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_traffic_limiter.sv"                                      -L altera_common_sv_packages -work master_non_sec_master_limiter                                   
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_reorder_memory.sv"                                       -L altera_common_sv_packages -work master_non_sec_master_limiter                                   
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_avalon_sc_fifo.v"                                               -L altera_common_sv_packages -work master_non_sec_master_limiter                                   
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_avalon_st_pipeline_base.v"                                      -L altera_common_sv_packages -work master_non_sec_master_limiter                                   
  ...
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_master_agent.sv"                                         -L altera_common_sv_packages -work master_non_sec_master_agent                                     
  ...
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_master_translator.sv"                                    -L altera_common_sv_packages -work master_non_sec_master_translator                                
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/soc_system_master_non_sec_p2b_adapter.sv"                              -L altera_common_sv_packages -work p2b_adapter                                                     
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/soc_system_master_non_sec_b2p_adapter.sv"                              -L altera_common_sv_packages -work b2p_adapter                                                     
  ...
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/soc_system_master_non_sec_timing_adt.sv"                               -L altera_common_sv_packages -work timing_adt                                                      
  ...
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_master_non_sec.v"                                                                        -work master_non_sec                                                  
