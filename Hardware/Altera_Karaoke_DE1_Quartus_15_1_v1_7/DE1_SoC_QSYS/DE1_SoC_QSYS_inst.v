	DE1_SoC_QSYS u0 (
		...
		.hps_fifo_ain_0_in_valid                     (<connected-to-hps_fifo_ain_0_in_valid>),                     //                    hps_fifo_ain_0_in.valid
		.hps_fifo_ain_0_in_data                      (<connected-to-hps_fifo_ain_0_in_data>),                      //                                     .data
		.hps_fifo_ain_0_in_ready                     (<connected-to-hps_fifo_ain_0_in_ready>),                     //                                     .ready
		.hps_fifo_aout_0_out_valid                   (<connected-to-hps_fifo_aout_0_out_valid>),                   //                  hps_fifo_aout_0_out.valid
		.hps_fifo_aout_0_out_data                    (<connected-to-hps_fifo_aout_0_out_data>),                    //                                     .data
		.hps_fifo_aout_0_out_ready                   (<connected-to-hps_fifo_aout_0_out_ready>),                   //                                     .ready
		...
		.hps_fifo_wav_0_out_valid                    (<connected-to-hps_fifo_wav_0_out_valid>),                    //                   hps_fifo_wav_0_out.valid
		.hps_fifo_wav_0_out_data                     (<connected-to-hps_fifo_wav_0_out_data>),                     //                                     .data
		.hps_fifo_wav_0_out_ready                    (<connected-to-hps_fifo_wav_0_out_ready>)                     //                                     .ready
	);
