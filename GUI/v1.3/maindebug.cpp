...
int main(int argc, char *argv[]) {
    ...
    while(1){
        ...
        songname=w.getSong();
        //checksong
        i2c_gui_data=w.geti2c();
        if(i2c_gui_data!=0){
            i2c_transaction((uint32_t)(0x340c00));//turn off
            i2c_transaction(i2c_gui_data);
            i2c_transaction((uint32_t)(0x341201));//turn on
            w.reseti2c();
        }
